...
{
  {DPID_PRESSURE_NOW, DP_TYPE_VALUE},
  {DPID_TEMPERATURE_NOW, DP_TYPE_VALUE},
};
...
void all_data_update(void)
{
    ...
    mcu_dp_value_update(DPID_PRESSURE_NOW,当前当前气压); //VALUE型数据上报;
    mcu_dp_value_update(DPID_TEMPERATURE_NOW,当前当前温度); //VALUE型数据上报;
